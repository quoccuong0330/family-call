...
export default function ListPrisoner() {
  return (
    <>
      <main id="page-danhsach-phamnhan">
        <HeaderComponent title="Quản lý phạm nhân / Danh sách phạm nhân"></HeaderComponent>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="btn-item">
                          <span class="js-popup-profile">
                            <i class="fa-regular fa-pen-to-square"></i>
                          </span>
                          <span class="c-fc--gray">
                    ...
                    <tr>
                      ...
                      <td>
                        <span>
                          10/02/2025<small class="note-time">15:30</small>
                        </span>
                      </td>
                      <td>
                        <div class="btn-item">
      ...
      <div class="popup">
        ...
        <div class="popup-show">
          <div class="popup-show__ttl">
            {" "}
            Đăng ký gọi : Phạm nhân Trần Huyền Diệp{" "}
          </div>
          <div class="popup-show__ct">
            ...
            <dl>
              <dt>
                Thời gian gọi<span class="note">(Tối đa 20 phút)</span>
              </dt>
              <dd>
                <div class="note-time">
                  <input type="text" class="form-control" />
          ...
          <div class="popup-show__sub">
            <button type="button" class="c-btn__01 c-bg--gray js-popup-close">
              Đóng
            </button>
            <button type="button" class="c-btn__01">
              Lưu
            </button>
          </div>
        </div>
